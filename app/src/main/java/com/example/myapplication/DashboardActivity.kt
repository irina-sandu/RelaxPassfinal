...
class DashboardActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun setNameAndEmailUser() {
        val headerView: View =
            navigationView.getHeaderView(0) // index 0 pentru primul header (dacă ai mai multe)
        val emailTextView: TextView =
            headerView.findViewById(R.id.emailTextViewId) // înlocuiește cu id-ul real
        val nameTextView: TextView =
            headerView.findViewById(R.id.nameTextViewId) // înlocuiește cu id-ul real
